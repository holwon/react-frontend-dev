...
1. **Testing Trophy Philosophy**:
   ...
   - Test **user behavior and visible UI outcomes** (e.g. `screen.getByRole`, `userEvent.click`), NEVER internal state variables or private instance methods. Testing internals couples tests to implementation — they break on refactors that don't change behavior.
